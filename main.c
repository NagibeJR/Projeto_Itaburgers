...
{ //ordenar os itens por ordem de pre�o e nao por ordem de escolha
    int i, j, aux = 0;
...
void Limpar_Texto(int i) //ap�s remover o item o nome dele ser removido da lista
{
    for (int j = 0; j < i; j++)
        printf(" ");
}
...
void categorias(char nome[]) //interface que redireciona o usu�rio para os locais onde pode-se escolher seu pedido, finalizar a compra,cancelar a compra e verificar o carrinho de compras
{
    textcolor(YELLOW);
...
void modosPagamento(struct cliente usuario) //tela onde o usu�rio ir� escolher o melhor metodo de pagamento para ele
{
...
void notaFiscalDesc(struct cliente usuario) //informa��es finais da compra
{
